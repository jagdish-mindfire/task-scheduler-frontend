            ...
            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all">
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-left sm:ml-4 sm:mt-0 sm:text-left w-full" style={{width:'300px'}}>
                    <DialogTitle as="h2" className="mb-7 text-base font-semibold leading-6 text-gray-900 text-center">
                      {formtTitle}
                      <hr />
                    </DialogTitle>
