...
import { DropdownMenuTrigger, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator } from "../Common/DropdownMenu.js";
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-gray-800 text-white">
              <DropdownMenuLabel>{CONSTANT_STRING.MY_ACCOUNT}</DropdownMenuLabel>
              <DropdownMenuSeparator className="bg-gray-700" />
              <DropdownMenuItem className="hover:bg-gray-700">{CONSTANT_STRING.PROFILE}</DropdownMenuItem>
              <DropdownMenuItem className="hover:bg-gray-700">{CONSTANT_STRING.SETTINGS}</DropdownMenuItem>
              <DropdownMenuItem className="hover:bg-gray-700" onClick={logout}>{CONSTANT_STRING.LOGOUT}</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </header>
