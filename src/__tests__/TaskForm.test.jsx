...
describe("TaskForm Component", () => {
  ...
  test("Submits valid form data", async () => {
    ...
    // Fill out the form
    fireEvent.change(getByTestId("title"), { target: { value: "Task Title" } });
    fireEvent.change(getByTestId("description"), { target: { value: "Task Description" } });
    fireEvent.change(getByTestId("due_date"), { target: { value: "2023-12-31" } });
